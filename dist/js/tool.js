...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getTenants: function getTenants() {
      var _this = this;
      Nova.request().get('/nova-vendor/tenant-filter/tenants').then(function (response) {
        _this.tenants = response.data;
      });
    },
    getSelectedTanant: function getSelectedTanant() {
      var _this2 = this;
      Nova.request().get('/nova-vendor/tenant-filter/tenants/globalTenantFilter').then(function (response) {
        _this2.selected = response.data.tenant_id;
      });
    },
    onChange: function onChange(event) {
      Nova.request().post('/nova-vendor/tenant-filter/tenants/globalTenantFilter', {
        tenant_id: event
      }).then();
    }
  }
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
  "class": "pr-2"
}, " Активный фильтр тенанта: ", -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Head, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [_hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return $data.selected = $event;
        }),
        onChange: _cache[1] || (_cache[1] = function ($event) {
          return $options.onChange($data.selected);
        })
      }, [_hoisted_2, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.tenants, function (tenant) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
          value: tenant.id
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(tenant.slug), 9 /* TEXT, PROPS */, _hoisted_3);
...
/* harmony import */ var _home_maxsust_erp_vendor_globaldrive_tenant_filter_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_home_maxsust_erp_vendor_globaldrive_tenant_filter_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Tool_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Tool_vue_vue_type_template_id_ef10eebe__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/pages/Tool.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgd_tenant_filter"] = self["webpackChunkgd_tenant_filter"] || [];
